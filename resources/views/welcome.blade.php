			...
			<div class="col-sm-6">
				<ul class="d-lg-flex header-w3_pvt">
					...
					<li>
						...
						<p class="d-inline"><a href='tel:08035562231'>Call Us +234 80 3556 2231</a></p>
					</li>
				</ul>
			</div>
	...
	<div class="container">
		...
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				<li class=""><a href="/login">Admin</a></li>
			</ul>
			<div class="login-icon ml-2">
				<a class="user" href="/book"> Book Now</a>
			</div>
		</nav>
		<div class="clear"></div>
		<!-- //nav -->
							...
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4"><span>Quality  </span> Treatments.</h3>
										...
										Cubilia Curae.</p>
										<a href="/book" class="btn btn-banner1 my-sm-3 mb-3">Consult Us</a>
									</div>
								</div>
							</li>
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4"><span>We care about </span> you</h3>
										<p class="w3ls_pvt-title my-3">Onec Consequat Sapien Ut Leo Cursus Rhoncus. Nullam Dui Mi, Vulputate Ac 
										Metus Semper Nullam Dui Mi. Vestibulum Ante Ipsum Primis In Faucibus Orci Luctus Et Ultrices Posuere 
										Cubilia Curae.</p>
										<a href="/book" class="btn btn-banner1 my-sm-3 mb-3">Consult Us</a>
...
<section class="about py-5">
	<div class="container py-md-3">
		...
		<div class="row">
			<div class="col-lg-8">
				<h4 class="about-left">We Value You!</h4>
			...
			<div class="col-lg-4 col-md-8 dental">
				<img src="images/gallery2.jpg" class="img-fluid" alt="" />
			</div>
		</div>
	</div>
</section>
...
<section class="appointment text-center py-5">
	<div class="container py-sm-3">
		<h4>live a healthy life</h4>
		<p class="mt-3">Book Your Appointment Today</p>
		<a href="/book">Book</a>
	</div>
</section>
<!-- //appointment -->
	...
	<div class="container py-sm-3">
		<div class="row footer-grids">
			...
			<div class="col-lg-4 col-sm-6">
				<h4 class="mb-sm-4 mb-3">Follow Us</h4>
